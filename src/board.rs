...
use crate::constants::STARTPOS;
use crate::coords::{File, Rank, Square};
use crate::piece::{Piece, PieceType};
use crate::zobrist::Zobrist;
use crate::{attacks, movegen};
...
impl Board {
    ...
    pub fn is_game_over(&self) -> (GameResultReason, GameResult) {
        ...
        use crate::movegen::{MoveGenType, PieceGenType, legalmoves};
        let mut ml = crate::movelist::Movelist::new();
...
mod tests {
    ...
    fn xfen_with_makemove() {
        ...
        let mv = crate::uci::parse_san(&board, "Rhh1").expect("Rhh1 should parse");
    ...
    fn zobrist_hash_startpos() {
        ...
        let mv = crate::uci::uci_to_move(&b, "e2e4");
        ...
        let mv = crate::uci::uci_to_move(&b, "d7d5");
        ...
        let mv = crate::uci::uci_to_move(&b, "e4e5");
    ...
    fn zobrist_hash_white_castling() {
        ...
        let mv = crate::uci::uci_to_move(&b, "e1g1");
        ...
        b.set_fen("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1");
        let mv = crate::uci::uci_to_move(&b, "e1c1");
        ...
        let mv = crate::uci::uci_to_move(&b, "h1h2");
    ...
    fn zobrist_hash_black_castling() {
        ...
        b.set_fen("r3k2r/8/8/8/8/8/8/R3K2R b KQkq - 0 1");
        let mv = crate::uci::uci_to_move(&b, "e8d7");
        ...
        let mv = crate::uci::uci_to_move(&b, "d5a8");
        ...
        let mv = crate::uci::uci_to_move(&b, "a8a7");
    ...
    fn zobrist_hash_enpassant() {
        ...
        let mv = crate::uci::uci_to_move(&b, "e7e5");
